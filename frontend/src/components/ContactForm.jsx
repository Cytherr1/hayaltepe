    ...
    >
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          email: Yup.string()
            .email(<FormattedMessage id="notemail" />)
            .required(<FormattedMessage id="required" />),
          subject: Yup.string()
            .max(20)
            .required(<FormattedMessage id="required" />),
          message: Yup.string()
            .min(25, <FormattedMessage id="tooshort" />)
            .max(300)
            .required(<FormattedMessage id="required" />),
          policy: Yup.bool().oneOf(
            [true],
            <FormattedMessage id="checkpolicy" />
          ),
        })}
      >
          ...
          <form onSubmit={handleSubmit}>
            <VStack spacing="1em">
              ...
              <FormControl isInvalid={touched.email && errors.email}>
                <FormLabel fontWeight="600" fontSize="lg" htmlFor="email">
              ...
              <FormControl isInvalid={touched.subject && errors.subject}>
                <FormLabel fontWeight="600" fontSize="lg" htmlFor="subject">
              ...
              <FormControl isInvalid={touched.message && errors.message}>
                <FormLabel fontWeight="600" fontSize="lg" htmlFor="message">
                ...
                <Field
                  ...
                  maxLength="300"
                />
                <Text fontSize="xs" mr="25px" color="dg.500">
                  {charCount}/300
                </Text>
              ...
              <Button variant="form" w="100%" isLoading={load} type="submit">
